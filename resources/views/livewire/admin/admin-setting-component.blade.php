                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="saveSettings">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Hotline</label>
                                <div class="col-md-4">
                                    <input type="text" placeholder="Hotline" class="form-control input-md" wire:model="hotline">
                                    @error('hotline') <p class="text-danger">{{$message}}</p>@enderror
                                </div>
                            </div>
