        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">    
            <div class="icon-stat">    
              <div class="row">
                <div class="col-xs-8 text-left">
                  <span class="icon-stat-label">Porducts</span>
                  <span class="icon-stat-value">{{$products_count}}</span>
                </div>    
                <div class="col-xs-4 text-center">
                  <i class="fa fa-th icon-stat-visual bg-secondary"></i>
                </div>
              </div>    
              <div class="icon-stat-footer">
                <i class="fa fa-clock-o"></i> Updated Now
            ...
            <div class="icon-stat">    
              <div class="row">
                <div class="col-xs-8 text-left">
                  ...
                  <span class="icon-stat-value">{{$orders_count}}</span>
                </div>    
                <div class="col-xs-4 text-center">
