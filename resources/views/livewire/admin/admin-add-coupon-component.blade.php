                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="" wire:submit.prevent="storeCoupon">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="">Coupon Code</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="">Coupon Type</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="">Coupon Value</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="">Cart Value</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="">Expiry Date</label>
