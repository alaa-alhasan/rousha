...
use App\Http\Livewire\Admin\AdminAddBannerComponent;
...
use App\Http\Livewire\Admin\AdminEditBannerComponent;
...
Route::get('/product/{slug}', DetailsComponent::class)->name('product.detalis');
...
Route::middleware(['auth:sanctum','verified','authadmin'])->group(function () {
    ...
    Route::get('/admim/home-categories', AdminHomeCategoryComponent::class)->name('admin.homecategories');
    ...
    Route::get('/admin/team/edit/{member_id}', AdminEditTeamComponent::class)->name('admin.editteam');

    Route::get('/admin/banner', AdminBannerComponent::class)->name('admin.banner');
    Route::get('/admin/banner/add', AdminAddBannerComponent::class)->name('admin.addbanner');
    Route::get('/admin/banner/edit/{banner_id}', AdminEditBannerComponent::class)->name('admin.editbanner');
});