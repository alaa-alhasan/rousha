...
class CartComponent extends Component
{
    ...
    public function destroyAll(){
        ...
        $this->dispatchBrowserEvent('empty_cart_success',[
    ...
    public function render()
    {
        ...
        return view('livewire.cart-component',['viewedProducts' => $viewedProducts, 'sale' => $sale])->layout("layouts.base");
    }
}
